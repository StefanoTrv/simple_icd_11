...
- [simple\_icd\_11](#simple_icd_11)
  ...
  - [Entity](#entity)
    ...
    - [getPostcoordinationScale() -\> dict\[str, list\[Entity\]\]](#getpostcoordinationscale---dictstr-listentity)
...
### getPostcoordinationScale() -> dict[str, list[Entity]]
Returns a dictionary containing the post-coordination scale of the entity. The keys of the dictionary are the codes of the entities in the scale, while the values are the entities themselves. 
